...
import networks.dnhc.addressing as addressing
import networks.dnhc.util as util

AccessState = collections.namedtuple('AccessState', (
    'memory',
    #'read_weights', 'write_weights', 'linkage', 'usage'
     ))
...
class MemoryAccessInst(snt.RNNCore):
  ...
  *   `addressing.FreenessAllocator` for keeping track of memory usage, where
  ...
  def __init__(self,
    ...
    """
    super(MemoryAccessInst, self).__init__(name=name)
  ...
  def _build(self, inputs, prev_state):
    ...
    read_weights = self._read_weights(
        inputs,
        memory=memory,
        prev_read_weights=None, #prev_state.read_weights,
        link=None)
